...
public class AuthController {
    ...
    public static final String FAILED_TO_UPDATE_CURRENT_USER = "Failed to update current user";
    ...
    public ResponseEntity<Credential> getCurrentUser() {
        try {
            ...
            Credential credential = new Credential(currentUser.getName(), currentUser.getEmail());
    ...
    @Operation(summary = "Update current user credentials", description = "Update the details of the currently authenticated user")
    @ApiResponses(value = {
